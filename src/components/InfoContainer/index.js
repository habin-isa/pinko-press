...
const InfoContainer = () => {
  return (
    <S.Wrapper>
      <S.Content>
        Pinko Press is an independent publishing house, focusing on left-wing politics and culture with a specific
        interest in architecture. Taking cues from the rich history of radical publishing, Pinko aims to use "design as
        a means to welcome and encourage ideas."
      </S.Content>
      <S.Content>
        Social Constructs of Social Housing (PP001), an essay by Alfie Peacock which focuses on the shifting societal
